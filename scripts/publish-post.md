...
4. Deploy: set CLOUDFLARE_API_TOKEN from CF_TRATT_WORKERS_EDIT and CLOUDFLARE_ACCOUNT_ID from CF_TRATT_ACCOUNT_ID; run package script deploy from SITE_PATH.
